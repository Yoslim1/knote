# ============================================================================
# Knote – R8/ProGuard Keep-Regeln (Release)
#
...
-keepclassmembers @kotlinx.serialization.Serializable class com.dalelalmuslim.knote.** {
    *** Companion;
    kotlinx.serialization.KSerializer serializer(...);
}
-if @kotlinx.serialization.Serializable class com.dalelalmuslim.knote.**
-keep class com.dalelalmuslim.knote.**$$serializer { *; }
