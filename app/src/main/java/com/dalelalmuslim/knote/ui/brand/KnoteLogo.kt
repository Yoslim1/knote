...
package com.dalelalmuslim.knote.ui.brand
...
fun KnoteRing(
    ...
    ringColor: Color = KnoteBrand.OffWhite,
...
fun KnoteWordmark(
    modifier: Modifier = Modifier,
    letterColor: Color = KnoteBrand.OffWhite,
) {
    ...
    val render: DrawScope.() -> Unit = {
        ...
        drawArc(
            brush = Brush.linearGradient(
                0.0f to KnoteBrand.Red,
                0.25f to KnoteBrand.Orange,
                0.5f to KnoteBrand.Amber,
                0.75f to KnoteBrand.YellowGreen,
                1.0f to KnoteBrand.Green,
                start = gradStart,
                end = gradEnd,
            ),
            startAngle = -119f,
