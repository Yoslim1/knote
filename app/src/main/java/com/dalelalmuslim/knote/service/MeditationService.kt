...
package com.dalelalmuslim.knote.service
...
class MeditationService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START  = "com.dalelalmuslim.knote.meditation.START"
        const val ACTION_STOP   = "com.dalelalmuslim.knote.meditation.STOP"
        const val ACTION_PAUSE  = "com.dalelalmuslim.knote.meditation.PAUSE"
        const val ACTION_RESUME = "com.dalelalmuslim.knote.meditation.RESUME"
    ...
    private fun acquireWakeLock(ms: Long) {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "knote:meditation")
            .also { it.acquire(ms) }
    }
